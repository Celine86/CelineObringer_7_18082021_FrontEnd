<template>
    <main>
        ...
        <div class="main__nav">
            <button class="main__nav--button" @click="reload()">Rafraîchir</button>
            <a :href="'#/addpost/'" class="main__nav--button">Ajouter</a>
        </div>
            <div v-for="post in posts" :key="post.id" class="wrap--column">
